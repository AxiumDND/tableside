...
**[Download the latest installer](https://github.com/AxiumDND/tableside/releases/latest)** — look for `Tableside-Setup-1.4.5.exe`. No account, no admin.
...
Writes `dist/Tableside-Setup-1.4.5.exe`. Pushing a `v1.4.5` tag builds that file and attaches it to the [GitHub Release](https://github.com/AxiumDND/tableside/releases/latest).

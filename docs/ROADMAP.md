...
- **Party glance strip** — first pass in 1.8.19: DM-only **Quick links** bar under the header. Later: hide toggle. Notes: [QUICK-LINKS.md](QUICK-LINKS.md), [CALENDAR.md](CALENDAR.md).

...
**Target app version: 1.7.1+.** Night sheets use structured **combat** and **treasure** blocks (party auto-roster, item/monster lookup that copies into Gear / Bestiary). Prefer the formats below so Edit on a block works without hand-editing fences.

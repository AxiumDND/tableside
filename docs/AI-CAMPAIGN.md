...
Optional `Templates/` at the campaign root overrides built-in **New …** sheets (`Party Roster.md`, `Session Recap.md`, `Game Night Sheet.md`, `Player.md`, …). The folder is hidden in the file tree. Prefer the built-in 1.7.9 shapes unless the table already has a house template.

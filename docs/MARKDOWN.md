...
- **Pan** is the default: drag to move, scroll or the **Zoom** slider to zoom, **Fit** resets. **Scale map** sets the 5 ft grid. **Show to players** follows crop, fog, and tokens — pins stay DM-only.

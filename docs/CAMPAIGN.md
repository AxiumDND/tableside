...
- [AI-CAMPAIGN.md](AI-CAMPAIGN.md) — spec for an AI converting a vault into this layout (1.8.14: chronicle / crawl end still fades into the next Show to players picture)

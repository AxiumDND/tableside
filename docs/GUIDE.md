...
| **Quick links** | Second header strip: **Party** (AC / save DC / PP), **Conditions**, **Calendar** (date, time, Day / Night, hour and day buttons) |
...
The left **Files** list is your campaign folder. Click a note to open it in the center. The **Quick** strip under the header keeps Party AC / save DC / PP, condition text, and the in-world date one click away. **◀h** / **▶h** / **+Day** advance the clock; **⚙** picks Gregorian, Forgotten Realms, Greyhawk, or a custom week.

...
1. Create sheets under `Party/`, `NPCs/`, and `Bestiary/` (right-click the folder, or save from Lookup). For a D&D Beyond character, right-click **Party/** → **D&D Beyond sheet…** and paste the character link — the live sheet opens in a browser; copy AC/HP onto the Party sheet if you want them in Combat.

...
export const IPC = {
  ...
  playerShowHourglass: 'player:show-hourglass',
  playerStartHourglass: 'player:start-hourglass',
  playerPauseHourglass: 'player:pause-hourglass',
  playerResumeHourglass: 'player:resume-hourglass',
  playerResetHourglass: 'player:reset-hourglass',
  playerStopHourglass: 'player:stop-hourglass',

...
export const STOCK_ART: StockArtItem[] = [
  ...
  { id: 'Mountain', title: 'Mountain', group: 'place', aliases: ['mountains', 'peak', 'pass'] },
  { id: 'Swamp', title: 'Swamp', group: 'place', aliases: ['marsh', 'bog', 'fen'] },
  { id: 'Desert', title: 'Desert', group: 'place', aliases: ['dunes', 'wastes', 'badlands'] },
  { id: 'Mine', title: 'Mine', group: 'place', aliases: ['mines', 'quarry', 'mineshaft'] },
  { id: 'Tower', title: 'Tower', group: 'place', aliases: ['watchtower', 'spire'] },
  { id: 'Manor', title: 'Manor', group: 'place', aliases: ['estate', 'manor house', 'hall'] },
  { id: 'Farm', title: 'Farm', group: 'place', aliases: ['farmstead', 'homestead'] },
  { id: 'Graveyard', title: 'Graveyard', group: 'place', aliases: ['cemetery', 'churchyard'] },
  { id: 'Library', title: 'Library', group: 'place', aliases: ['archive', 'scriptorium'] },
  { id: 'Prison', title: 'Prison', group: 'place', aliases: ['jail', 'gaol'] },
  { id: 'Sewers', title: 'Sewers', group: 'place', aliases: ['sewer', 'undercity'] },
  { id: 'Monastery', title: 'Monastery', group: 'place', aliases: ['abbey', 'priory', 'cloister'] },
  { id: 'Crossroads', title: 'Crossroads', group: 'place', aliases: ['crossroad', 'junction'] },
  { id: 'Camp', title: 'Camp', group: 'place', aliases: ['encampment', 'campsite'] },
  { id: 'Lake', title: 'Lake', group: 'place', aliases: ['loch', 'tarn'] },
  { id: 'Island', title: 'Island', group: 'place', aliases: ['isle'] },
  { id: 'Ship', title: 'Ship', group: 'place', aliases: ['vessel', 'galleon'] },
  { id: 'Coast', title: 'Coast', group: 'place', aliases: ['beach', 'shore', 'seashore', 'coastline'] },
  { id: 'Underdark', title: 'Underdark', group: 'place', aliases: ['deep dark'] },
  { id: 'Academy', title: 'Academy', group: 'place', aliases: ['college', 'university'] },

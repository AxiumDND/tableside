...
> | | |
> |---|---|
> | **Aliases** | "Urwin the innkeep" |
> | **Ancestry** | Wereraven (appears human) |
> | **Role** | Patron and moral compass |
> | **Faction** | Keepers of the Feather |
...
traits:
  - name: Shapechanger
    desc: "Bonus action: shift between humanoid, raven, and hybrid. Stats stay the same; can't speak in raven form; reverts on death."
  - name: Mimicry
    desc: "Can mimic simple sounds it has heard (DC 12 Insight to discern the trick)."
actions:
  - name: Multiattack
    desc: "Two attacks, only one of which can be a Beak."
  - name: Beak (raven or hybrid only)
    desc: "+5 to hit, reach 5 ft. Hit: 8 (2d4+3) piercing."

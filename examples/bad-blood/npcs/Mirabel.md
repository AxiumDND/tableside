...
> | | |
> |---|---|
> | **Ancestry** | Was human; now a Ghast Gravecaller |
> | **Role** | Tavern boss — second floor *(backup only)* |
> | **Faction** | Was co-owner of the Blood of the Vine |
> | **Location** | Tavern upper floor |
...
traits:
  - name: Stench
    desc: "DC 13 Constitution save, any creature that starts its turn within 5 ft. Failure: Poisoned until the start of its next turn. Success: immune to this ghast's Stench for 24 hours."
actions:
  - name: Multiattack
    desc: "Two Horrific Necrosis attacks. Can replace one with a Claw."
  - name: Claw
    desc: "+6 to hit, reach 5 ft. Hit: 13 (3d6+3) slashing. If the target isn't Undead: Paralyzed until the end of its next turn."
  - name: Horrific Necrosis
    desc: "+7 to hit, reach 5 ft. or range 120 ft. Hit: 15 (2d10+4) necrotic, and Frightened until the end of its next turn."
  - name: Spellcasting

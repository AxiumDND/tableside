...
traits:
  ...
  - name: Sneak Attack (1/Turn)
    desc: "Extra 7 (2d6) damage when it hits with advantage, or when an ally is within 5 ft. of the target and the spy doesn't have disadvantage."
actions:
  - name: Multiattack
    desc: "Two Shortsword attacks."
  - name: Shortsword
